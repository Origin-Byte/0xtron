...
public class TransactionsUIController : MonoBehaviour
{
    ...
    private async void Start()
    {
        ...
        IncrementCounterButton.onClick.AddListener(async () =>
        {
            ...
            await SuiApi.Client.ExecuteTransactionAsync(txBytes, SuiSignatureScheme.ED25519, signature, pkBase64, SuiExecuteTransactionRequestType.WaitForEffectsCert);
    ...
    {
        var rpcResult = await SuiApi.Client.GetObjectAsync(SharedCounterObjectId);
